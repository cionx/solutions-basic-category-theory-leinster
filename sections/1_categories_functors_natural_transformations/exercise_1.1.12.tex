...
the class of objects of~$\Mod{R}$ is the class of left~\modules{$R$}, the morphisms in~$\Mod{R}$ are the homomorphisms of~\modules{$R$}, and composition of morphisms in~$\Mod{R}$ is given by composition of functions.
