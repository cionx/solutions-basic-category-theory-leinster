...
An essential inverse~$U'$ of~$U$ together with a natural isomorphism from~$U' ∘ U$ to~$\Id_{\FDVect}$ amounts to choosing a basis for every finite-dimensional~\vectorspace{$𝕜$}.
