...
We need to show that the transformation~$α$ is natural.
...
%	\]
%	This shows that the functor~$J_*$ is again an equivalence of categories, and therefore in particular full and faithful.
%
...
%
%	The functor~$J'$ is again full and faithful, and it is essentially surjective.
%	It is therefore an equivalence of categories.
%	We have seen above that the induces functor~$J' ∘ (\ph)$ is therefore again full and faithful.
%
%\end{remark}
