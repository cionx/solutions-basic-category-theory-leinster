...
We see that for any two distinct objects~$A$ and~$A'$ of~$\cat{A}$, there exist no natural transformations beween the associated presheaves~$\HY_A$ and~$\HY_{A'}$, just as there exist no morphisms between~$A$ and~$A'$.
